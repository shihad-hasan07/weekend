    ...
    return (
        <div className="container mx-auto px-20 mt-20">
            ...
            <div className="flex items-center justify-between mt-14">
                <div>
                    <span className="text-[#999999] text-3xl font-bold">250+</span> <br />
                    <span className="text-[#999999]  font-semibold">Collaboration</span>
                </div>
                <img src="/banner/duolingo.png" alt="" />
                <img src="/banner/codecov.png" alt="" />
                <img src="/banner/usertesting.png" alt="" />
                <img src="/banner/magicleap.png" alt="" />
            </div>
        </div>
    );
};
