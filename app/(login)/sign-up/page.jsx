          ...
          <div className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 transition-all"
                  style={{ focusRing: '2px solid #20b486' }}
                  onFocus={(e) => e.target.style.borderColor = '#20b486'}
                  onBlur={(e) => e.target.style.borderColor = '#d1d5db'}
                />
            ...
            <div className="flex items-start">
              <input
                ...
                style={{ accentColor: '#20b486' }}
              />
              <label htmlFor="terms" className="ml-2 text-sm text-gray-600 cursor-pointer">
                I agree to the{' '}
                <button className="font-semibold hover:underline" style={{ color: '#20b486' }}>
                  Terms of Service
                </button>
                {' '}and{' '}
                <button className="font-semibold hover:underline" style={{ color: '#20b486' }}>
            ...
            <button
              ...
              className="w-full py-3 px-4 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]"
